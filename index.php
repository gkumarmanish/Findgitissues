                    ...
                    if ($_SESSION && empty($_SESSION['error'])) {
                        ...
                        <div id="third_div">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>Number of open issues that were opened in the last 24 hours</td><td><span style="float: right;"><?php
                                ...
                                <tr>
                                    <td>Number of open issues that were opened more than 24 hours ago but less than 7 days ago</td><td>
                                ...
                                <tr>
                                    <td> Number of open issues that were opened more than 7 days ago </td><td>
